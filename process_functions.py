...
#     # Получаем client_info используя contact_id (здесь предполагается, что contact_id хранится в precheck)
#     chat_id = get_chat_id_by_contact_id(precheck['contact_id'])
#     if chat_id:
#         client_info = get_client_by_chat_id(chat_id)
#         if client_info:
#             pipeline_stage: str = (
#                 "Заказ" if int(category_id) == 8
#                 else {6: 'ПВ Астана №1', 2: 'ПВ Астана №2', 4: 'ПВ Караганда №1'}.get(int(category_id), "")
#             )
